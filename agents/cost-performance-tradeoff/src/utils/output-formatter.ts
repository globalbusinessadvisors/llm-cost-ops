...
import type { TradeoffAnalysisOutput, TradeoffResult } from '../contracts/index.js';
...
export class OutputFormatter {
   ...
   */
  private formatTable(output: TradeoffAnalysisOutput): string {
    const lines: string[] = [];
  ...
  private formatResultsHeader(): string {
    return [
      'Model'.padEnd(25),
      'Provider'.padEnd(12),
      'Cost'.padEnd(10),
  ...
  private formatResultRow(result: TradeoffResult): string {
