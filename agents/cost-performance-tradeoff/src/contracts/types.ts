...
import {
  ...
  TradeoffAnalysisInputSchema,
  TradeoffScoreSchema,
  DiminishingReturnsAnalysisSchema,
  ParetoPointSchema,
  TradeoffResultSchema,
  TradeoffRecommendationSchema,
  TradeoffAnalysisOutputSchema,
  DecisionTypeSchema,
  DecisionEventSchema,
  TradeoffErrorSchema
} from './schemas.js';
...
export type AnalysisResult =
  | { success: true; output: TradeoffAnalysisOutput }
  | { success: false; error: TradeoffError };
